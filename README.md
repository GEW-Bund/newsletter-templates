...
Hier findest du Newsletter-Vorlagen ("Templates") für den Versand von Mailings mit [Cleverreach](https://www.cleverreach.de).
...
Die umgewandelten, fertigen Templates kannst sind als **compiled.zip** archiviert und können direkt heruntergeladen werden. Darin enthalten sind Templates, die direkt in Cleverreach importiert werden können.
